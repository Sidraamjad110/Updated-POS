...
to {
  ...
  animation: ${J} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,$=({toast:e})=>{let{icon:r,type:n,iconTheme:a}=e;return void 0!==r?"string"==typeof r?f.createElement(K,null,r):r:"blank"===n?null:f.createElement(X,null,f.createElement(z,{...a}),"loading"!==n&&f.createElement(B,null,"error"===n?f.createElement(D,{...a}):f.createElement(G,{...a})))},Re=e=>`
